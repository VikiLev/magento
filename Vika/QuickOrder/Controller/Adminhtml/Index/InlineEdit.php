...
use Vika\QuickOrder\Api\Model\QuickOrderRepositoryInterface as OrderRepository;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Vika\QuickOrder\Api\Model\QuickOrderRepositoryInterface
     */
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $pageId) {
            /** @var \Vika\QuickOrder\Model\QuickOrder $page */
     ...
     * @return void
     */
    protected function validatePost(array $pageData, \Vika\QuickOrder\Model\QuickOrder $page, &$error, array &$messages)
    {
     ...
     * @return $this
     */
    public function setCmsPageData(\Vika\QuickOrder\Model\QuickOrder $page, array $extendedPageData, array $pageData)
    {
