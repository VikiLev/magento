...
use Vika\QuickOrder\Api\Model\Data\StatusInterfaceFactory;
use Vika\QuickOrder\Api\Model\StatusRepositoryInterface as StatusRepository;
use Vika\QuickOrder\Model\ResourceModel\StatusFactory;
...
class InlineEditStatus extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Vika\QuickOrder\Api\Model\StatusRepositoryInterface
     */
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $pageId) {
            /** @var \Vika\QuickOrder\Model\Status $page
             *@var \Vika\QuickOrder\Model\Status $modelStatus
             */
...
//            $lal = $resource->load($page, "1", "is_default");
     ...
     * @return void
     */
    protected function validatePost(array $pageData, \Vika\QuickOrder\Model\Status $page, &$error, array &$messages)
    {
     ...
     * @return $this
     */
    public function setCmsPageData(\Vika\QuickOrder\Model\Status $page, array $extendedPageData, array $pageData)
    {
